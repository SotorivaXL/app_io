...
class _ManageFormsState extends State<ManageForms> {
  ...
  StreamSubscription<QuerySnapshot<Map<String, dynamic>>>?
      _empresasSubscription;
  StreamSubscription<QuerySnapshot<Map<String, dynamic>>>?
      _campanhasSubscription;
  ...
  Future<void> _loadEmpresas() async {
    try {
      _empresasSubscription = FirebaseFirestore.instance
          .collection('empresas')
          .snapshots()
          .listen((snapshot) {
      ...
      StreamSubscription<QuerySnapshot<Map<String, dynamic>>> subscription =
        ...
        snapshot.docChanges.forEach((change) {
          if (change.type == DocumentChangeType.added) {
            ...
            setState(() {
              int index = forms.indexWhere((form) =>
                  form['id'] == change.doc.id &&
                  form['campanha_id'] == campanhaId);
              if (index != -1) {
                forms[index]['form_name'] =
                    change.doc['form_name'] ?? 'Formulário sem nome';
              }
            });
  ...
  Future<void> duplicateForm(
      String empresaId, String campanhaId, String formId) async {
    try {
      // Recupera o formulário original
      ...
      if (doc.exists) {
        ...
        Map<String, dynamic> formData = Map<String, dynamic>.from(doc.data()!);
        // (Opcional) Atualiza o nome para indicar que é uma cópia
        formData['form_name'] = "${formData['form_name']} - Cópia";

        // Adiciona o novo formulário na coleção
        ...
        showErrorDialog(
            context, "Formulário duplicado com sucesso!", "Sucesso");
      } else {
        showErrorDialog(context, "Formulário original não encontrado.", "Erro");
      }
    } catch (e) {
      print('Erro ao duplicar formulário: $e');
      showErrorDialog(context, "Erro ao duplicar formulário.", "Erro");
    }
  }
  ...
  void _showDeleteConfirmationDialog(
      String empresaId, String campanhaId, String formId) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: DropdownButtonFormField<String>(
                                isExpanded: true,
                                // Permite que o dropdown ocupe toda a largura disponível
                                alignment: Alignment.center,
                                // Alinha o conteúdo centralmente
                                value: selectedEmpresaId,
                                onChanged: (val) async {
                                  if (val != null) {
                                    setState(() {
                                      selectedEmpresaId = val;
                                      selectedEmpresaName = empresas.firstWhere(
                                          (empresa) =>
                                              empresa['id'] ==
                                              val)['NomeEmpresa'];
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(
                                    fontFamily: 'Poppins',
                                    fontSize:
                                        isDesktop ? 18 : 15, // Aumento da fonte
                            ...
                            if (selectedEmpresaId != null &&
                                campanhas.isNotEmpty)
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.0),
                                child: SizedBox(
                                  height:
                                      isDesktop ? 60 : 50, // Aumento da altura
                                  child: DropdownButtonFormField<String>(
                                    isExpanded: true,
                                    alignment: Alignment.center,
                                              ...
                                              child: ListTile(
                                                ...
                                                trailing: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    // Novo botão para duplicar o formulário
                                                    IconButton(
